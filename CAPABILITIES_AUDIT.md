...
| 4.3a-ii | Config-driven cleanup rules engine (7 step handlers, first-match-wins, rule-tag routing) | ✅ Wired | [`pipeline/cleanup_rules.py`](https://github.com/flemingss/Project-Atlas/blob/main/src/atlas/pipeline/cleanup_rules.py) | [TECHNICAL_DESIGN §3.6](TECHNICAL_DESIGN.md), [ARCHITECTURE §Pipeline Module](ARCHITECTURE.md) |
